...
const char* ssid = "sss";  // insert your SSID
const char* password = "110807002";  // insert your password
const char* host = "api.openweathermap.org";
const char* resource = "/data/2.5/weather?id=1668341&appid=87e0c6b6dfface4ea83cfc4aff0d579d"; 
...
const char* apiKey = "pf_bpNQofSHyCOx1MnVbt";  //IFTTT Applet key
